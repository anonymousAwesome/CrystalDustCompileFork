...
{
    [FRONTIER_FACILITY_TOWER]   = {OBJ_EVENT_GFX_ZANABEL,  TRUE},
    [FRONTIER_FACILITY_DOME]    = {OBJ_EVENT_GFX_ZTUCKER,  FALSE},
    [FRONTIER_FACILITY_PALACE]  = {OBJ_EVENT_GFX_ZSPENSER, FALSE},
    [FRONTIER_FACILITY_ARENA]   = {OBJ_EVENT_GFX_ZGRETA,   TRUE},
    [FRONTIER_FACILITY_FACTORY] = {OBJ_EVENT_GFX_ZNOLAND,  FALSE},
    [FRONTIER_FACILITY_PIKE]    = {OBJ_EVENT_GFX_ZLUCY,    TRUE},
    [FRONTIER_FACILITY_PYRAMID] = {OBJ_EVENT_GFX_ZBRANDON, FALSE},
};
...
{
    [FRONTIER_FACILITY_TOWER]   = TRAINER_ANABEL_FRONTIER,
    [FRONTIER_FACILITY_DOME]    = TRAINER_TUCKER_FRONTIER,
    [FRONTIER_FACILITY_PALACE]  = TRAINER_SPENSER_FRONTIER,
    [FRONTIER_FACILITY_ARENA]   = TRAINER_GRETA_FRONTIER,
    [FRONTIER_FACILITY_FACTORY] = TRAINER_NOLAND_FRONTIER,
    [FRONTIER_FACILITY_PIKE]    = TRAINER_LUCY_FRONTIER,
    [FRONTIER_FACILITY_PYRAMID] = TRAINER_BRANDON_FRONTIER,
};
...
static void CheckPartyIneligibility(void)
{
    ...
    do
    {
        ...
        do
        {
            u16 species = GetMonData(&gPlayerParty[monId], MON_DATA_SPECIES2,NULL);
