...
static void AddHatchedMonToParty(u8 id)
{
    ...
    if (pokeNum == SPECIES_TOGEPI &&
        GetMonData(mon, MON_DATA_MET_LOCATION,NULL) == METLOC_SPECIAL_EGG &&
        GetMonData(mon, MON_DATA_OT_ID,NULL) == T1_READ_32(gSaveBlock2Ptr->playerTrainerId))
    {
...
static u8 EggHatchCreateMonSprite(u8 a0, u8 switchID, u8 pokeID, u16* speciesLoc)
{
    ...
    case 1:
        ...
        spriteID = CreateSprite(&gMultiuseSpriteTemplate, 120, 70 + gMonFrontPicCoords[species].y_offset, 6);
