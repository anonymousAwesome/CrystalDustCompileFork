...
const u16 gTowerMaleTrainerGfxIds[30] =
{
    ...
    OBJ_EVENT_GFX_SAGE,
    OBJ_EVENT_GFX_MR_POKEMON,
    OBJ_EVENT_GFX_YOUNGSTER,
    OBJ_EVENT_GFX_FISHERMAN,
    OBJ_EVENT_GFX_ZCYCLING_TRIATHLETE_M,
    OBJ_EVENT_GFX_CLEFAIRY,
    OBJ_EVENT_GFX_CLEFAIRY,
    OBJ_EVENT_GFX_WORKER_M,
    OBJ_EVENT_GFX_ROCKER,
    OBJ_EVENT_GFX_ZNINJA_BOY,
...
const u16 gTowerFemaleTrainerGfxIds[20] =
{
    ...
    OBJ_EVENT_GFX_ZCYCLING_TRIATHLETE_F,
...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_LEADER_M, FACILITY_CLASS_LEADER_BUGSY},
    ...
    {RS_FACILITY_CLASS_WALLY, FACILITY_CLASS_RIVAL},
    {RS_FACILITY_CLASS_BRENDAN_1, FACILITY_CLASS_EM_BRENDAN},
    {RS_FACILITY_CLASS_BRENDAN_2, FACILITY_CLASS_BRENDAN_2},
    {RS_FACILITY_CLASS_BRENDAN_3, FACILITY_CLASS_BRENDAN_3},
    {RS_FACILITY_CLASS_MAY_1, FACILITY_CLASS_EM_MAY},
...
void FrontierSpeechToString(const u16 *words)
{
    ...
    if (GetStringWidth(2, gStringVar4, -1) > 204u)
    {
        s32 i = 0;
